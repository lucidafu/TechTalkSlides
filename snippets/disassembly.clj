...
0x100001825 <+37>:  callq  0x100003b3a               ; symbol stub for: objc_storeStrong
...
0x10000183d <+61>:  jge    0x100001869               ; <+105> at AppDelegate.m:20
0x100001843 <+67>:  movq   -0x18(%rbp), %rax
0x100001847 <+71>:  movq   0x4522(%rip), %rsi        ; "play"
0x10000184e <+78>:  movq   %rax, %rdi
0x100001851 <+81>:  callq  0x100003b28               ; symbol stub for: objc_msgSend
...
0x100001864 <+100>: jmp    0x100001837               ; <+55> at AppDelegate.m:20
0x100001869 <+105>: xorl   %eax, %eax
0x10000186b <+107>: movl   %eax, %esi
0x10000186d <+109>: leaq   -0x18(%rbp), %rcx
0x100001871 <+113>: movq   %rcx, %rdi
0x100001874 <+116>: callq  0x100003b3a               ; symbol stub for: objc_storeStrong
